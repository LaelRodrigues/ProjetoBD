...
public class EnderecoJDBC extends GenericDao implements IEndereco {
	...
	protected String retornarValoresBD(Endereco endereco) {
		...
		return retornarValorStringBD(endereco.getCep()) + ", " + retornarValorStringBD(endereco.getUf()) + ", "
				+ retornarValorStringBD(endereco.getCidade()) + ", " + retornarValorStringBD(endereco.getBairro())
